...
void setup()
{
  ...
  //DW1000Ranging.startAsTag(TAG_ADD, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false); // for group A
  ...
  DW1000Ranging.startAsTag(TAG_ADD, DW1000.MODE_LONGDATA_RANGE_ACCURACY, DW1000.CHANNEL_7, false); // for group B
}
